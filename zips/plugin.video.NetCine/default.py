...
nome_contador = "NetCine"
link_contador = "https://whos.amung.us/pingjs/"    


##CONFIGURAÇÕES
####  TITULO DO MENU  #################################################################
title_menu = "[B][COLOR red]Seja Bem-Vindo(a) ao NETCINE[/COLOR][/B]"
###  DESCRIÇÃO DO ADDON ###############################################################
...
url_origem = 'https://raw.githubusercontent.com/trynyx005/NetCine/main/Menu-Principal'
try:
...
def init_SKindex(msg):
   ...
   if status_mensagem1 == 'true':
    dialog = xbmcgui.Dialog()
    link = dialog.select("[B] [COLOR green] BEM-VINDOS AO - [/COLOR][COLOR red]NetCine[/COLOR][/B]", [
    "[B][COLOR blue]Facebook - [/COLOR] FACEBOOK [/B]",
    "[B][COLOR orange]Twitter - [/COLOR] TWITTER [/B]",
    "[B][COLOR purple]Instagram - [/COLOR] INSTAGRAM [/B]",
    "[B][COLOR yellow]Entrar - [/COLOR] ENTRAR NO ADD-ON [/B]"])    
